    ...
    fun bind(
        ...
        val disposableHandle =
            ...
            repeatOnLifecycle(Lifecycle.State.CREATED) {
                ...
                launch {
                    viewModel.reverseChargingMessage.collect { msg ->
                        if (
                            !Objects.equals(
                                ambientIndicationContainer.mReverseChargingMessage,
                                msg,
                            ) || ambientIndicationContainer.mWirelessChargingMessage != null
                        ) {
                            ambientIndicationContainer.mWirelessChargingMessage = null
                            ambientIndicationContainer.mReverseChargingMessage = msg
                            ambientIndicationContainer.updatePill()
                        }
                    }
                }
                launch {
                    viewModel.wirelessChargingMessage.collect { msg ->
                        if (
                            !Objects.equals(
                                ambientIndicationContainer.mWirelessChargingMessage,
                                msg,
                            ) || ambientIndicationContainer.mReverseChargingMessage != null
                        ) {
                            ambientIndicationContainer.mWirelessChargingMessage = msg
                            ambientIndicationContainer.mReverseChargingMessage = null
                            ambientIndicationContainer.updatePill()
                        }
                    }
